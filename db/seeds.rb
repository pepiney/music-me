...
Room.create(name: "Infinity Pool Music Studio", city: "Paris", user: user1 , user_id: 1, photo:"https://www.recordingstudiomarseille.com/images/regieOK2.jpg", address:"58 Rue de Rivoli, 75004 Paris", description:" Salle luxueuse avec tout instruments sur place, toît terrasse 150m2!")
Room.create(name: "Chez Les Chanteurs Veners", city: "Paris", user: user1 , user_id: 1, photo:"https://www.citemusicale-metz.fr/media/cmm/187370-studio.jpg", address:"8 Avenue Félix Faure, 75015 Paris", description:" Home studio avec pleins de guitares veners, bières acceptés!")
